...
I want to keep this issue in the discussion here because projects not always are straight forward. Bad data are everywhere, and mistakes like this can happen.
...
get_judgment_text <- function(url, bow){
  ...
  path <- paste0(str_remove(url, "\\?p="), ".html")
